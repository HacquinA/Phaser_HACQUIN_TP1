...
function preload(){
	this.load.image('background','assets/Yellow.png',);
	...
	this.load.image('vie_3','assets/ananas.png');
	this.load.image('vie_2','assets/ananas.png');
	this.load.image('vie_1','assets/ananas.png');
	this.load.image('vie_0','assets/ananas.png');
}
